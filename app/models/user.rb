class User < ApplicationRecord
  ...
  validates :first_name, presence: true, format: { with: /\A[一-龥ぁ-んァ-ヶー－]+\z/, message: " is invalid. Input full-width characters" }
  validates :last_name, presence: true, format: { with: /\A[一-龥ぁ-んァ-ヶー－]+\z/, message: " is invalid. Input full-width characters" }
